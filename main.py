"""
fortnite skin swapper - Advanced Game Cheat Engine
Repository: Fortnite-Skin-Swapper-2026-PC
License: MIT
"""
import sys
import time
...
class AimbotAimbot:
    ...
    def find_best_goal(self, objects) -> Optional[dict]:
        ...
        for ply in objects:
            ...
            if goal:
                fov = AimbotAimHelper.calculate_angle(self.get_local_pos(), goal)[0]
    ...
    def aim_at(self, player_data):
        ...
        goal_angle = AimbotAimHelper.calculate_angle(local_pos, goal)
        current_angle = self.get_view_angles()
        new_angle = AimbotAimHelper.smooth_angle(current_angle, goal_angle, self.smooth)
